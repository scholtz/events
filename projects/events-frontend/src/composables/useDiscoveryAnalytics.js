 ...
 */
async function dispatchDiscoveryEvent(event) {
    try {
        await gqlRequest(TRACK_DISCOVERY_ACTION_MUTATION, {
            input: {
...
export function useDiscoveryAnalytics() {
     ...
     */
    function trackSearch(activeFilterCount, resultCount) {
     ...
     */
    function trackFilterChange(activeFilterCount, resultCount) {
        dispatchDiscoveryEvent({
     ...
     */
    function trackFilterClear(resultCount) {
        dispatchDiscoveryEvent({
     ...
     */
    function trackResultClick(eventSlug, activeFilterCount) {
        dispatchDiscoveryEvent({
