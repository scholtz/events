export default {
  ...
  submitEvent: {
    ...
    countryCodePlaceholder: 'napr. SK',
    attendanceMode: 'Režim účasti',
  ...
  dashboard: {
    ...
    hubTagline: 'Tagline hubu (voliteľné)',
  ...
  portfolio: {
    ...
    filterDateTo: 'Do',
    clearFilters: 'Vymazať filtre',
    ariaFilterStatus: 'Filtrovať podľa stavu',
    ariaFilterDomain: 'Filtrovať podľa kategórie',
    ariaFilterLanguage: 'Filtrovať podľa jazyka',
    ariaFilterDateFrom: 'Filtrovať od dátumu',
    ariaFilterDateTo: 'Filtrovať do dátumu',
    ariaSortEvents: 'Zoradiť udalosti',
    sortBy: 'Zoradiť podľa',
  ...
  admin: {
    ...
    domainSlugPlaceholder: 'napr. krypto',
    domainSubdomainPlaceholder: 'napr. krypto',
    domainDescriptionPlaceholder: 'Popis (voliteľné)',
    noDomainsYet: 'Zatiaľ žiadne tagy. Pridajte jeden vyššie.',
    domainOverviewSaved: '\u2713 Uložené',
    domainOverviewContent: 'O tomto hub-e',
    domainTagline: 'Tagline hubu (voliteľné)',
    domainTaglinePlaceholder: 'napr. Objavte budúcnosť blockchain podujatí.',
    ...
    rejectionPanelHeading: 'Vrátiť na úpravu',
    eventRejectionNotePlaceholder: 'Vysvetlite, čo musí organizátor opraviť pred opätovným odoslaním (voliteľné)',
    submitRejection: 'Vrátiť na úpravu',
    cancelRejection: 'Zrušiť',
    queueTag: 'Tag',
    queueDate: 'Dátum',
    queueStatus: 'Stav',
    queueActions: 'Akcie',
    submittedToday: 'Odoslané dnes',
    submittedDaysAgo: 'Odoslané pred {days} d',
    warn_shortDescription: 'Krátky popis',
    warn_missingVenue: 'Chýba miesto',
    warn_missingCity: 'Chýba mesto',
    warn_missingTimezone: 'Chýba časové pásmo',
    warn_missingDomain: 'Chýba tag',
    rejCat_incompleteInfo: 'Neúplné informácie',
    rejCat_weakDescription: 'Slabý popis',
    rejCat_invalidUrl: 'Neplatná URL',
    rejCat_wrongCategory: 'Nesprávna kategória',
    rejCat_pastEvent: 'Uplynulá udalosť',
    rejCat_duplicate: 'Duplikát',
    ...
    communityGroupName: 'Názov',
    communityGroupVisibility: 'Viditeľnosť',
    communityGroupMembers: 'Členovia',
    communityGroupPending: 'Čakajúce',
    communityGroupStatus: 'Stav',
    communityGroupActions: 'Akcie',
    communityGroupActive: 'Aktívna',
    communityGroupInactive: 'Neaktívna',
    communityGroupView: 'Zobraziť',
    communityGroupViewAriaLabel: 'Zobraziť komunitu {name}',
    noCommunityGroups: 'Zatiaľ neboli vytvorené žiadne komunitné skupiny.',
  },
  ...
  hubManage: {
    ...
    schedules: {
      title: 'Naplánované featured podujatia',
      hint: 'Propagujte vybrané podujatia počas definovaného časového okna. Aktívne plány sa zobrazujú pred bežnými výsledkami na stránke hubu.',
      empty: 'Žiadne naplánované zvýraznenia.',
      loadError: 'Plány sa nepodarilo načítať.',
      saveError: 'Uloženie plánu zlyhalo. Skúste to znova.',
      addNew: '+ Pridať naplánované zvýraznenie',
      event: 'Podujatie',
      selectEvent: 'Vyberte podujatie…',
      startsAt: 'Začiatok (UTC)',
      endsAt: 'Koniec (UTC)',
      priority: 'Priorita (nižšia = skôr)',
      priorityLabel: 'Priorita {n}',
      create: 'Naplánovať',
      created: 'Plán vytvorený.',
      edit: 'Upraviť',
      save: 'Uložiť zmeny',
      remove: 'Odstrániť',
      status: {
    ...
    curatedCommunities: {
      title: 'Kurácie komunitných skupín',
      hint: 'Vyberte verejné komunitné skupiny, ktoré sa zobrazia na tomto hube. Každú položku možno povoliť/zakázať a opatriť krátkym vysvetlivkou.',
      empty: 'Zatiaľ žiadne kurácie komunitných skupín.',
      loadError: 'Nepodarilo sa načítať kurácie komunít.',
      saveError: 'Nepodarilo sa uložiť kurácie komunít. Skúste to znova.',
      reviewError: 'Žiadosť sa nepodarilo spracovať. Skúste to znova.',
      saved: '✓ Uložené',
      saving: 'Ukladám…',
      ...
      add: 'Pridať komunitu',
      remove: 'Odstrániť',
      annotation: 'Poznámka správcu (voliteľná)',
      annotationPlaceholder: 'napr. Hlavná organizátorská skupina tohto hubu…',
      enabled: 'Povolené (zobraziť verejne)',
      disabledBadge: 'Zakázané',
      noEligibleGroups: 'Žiadne verejné komunitné skupiny nie sú dostupné na pridanie.',
      groupPublic: 'Verejná',
      groupPrivate: 'Súkromná',
      pendingRequestsTitle: 'Čakajúce žiadosti o zaradenie',
      requestNote: 'Poznámka žiadateľa',
      approve: 'Schváliť',
      reject: 'Zamietnuť',
      rejectionNotePlaceholder: 'Voliteľná poznámka k zamietnutiu…',
    },
  },
  ...
  community: {
    ...
    lastSyncedSuccessfully: 'Posledná úspešná synchronizácia',
    lastSyncNoSuccess: 'Posledná synchronizácia mala chyby',
    ...
    autoSyncOn: 'Auto-sync zapnutý',
    autoSyncOff: 'Auto-sync vypnutý',
    autoSyncEnabled: 'Automatická synchronizácia prebieha každú hodinu',
    autoSyncDisabled: 'Automatická synchronizácia je pre tento zdroj vypnutá',
    enableAutoSync: 'Zapnúť auto-sync',
    disableAutoSync: 'Vypnúť auto-sync',
    enableAutoSyncAriaLabel: 'Zapnúť automatickú synchronizáciu na pozadí',
    disableAutoSyncAriaLabel: 'Vypnúť automatickú synchronizáciu na pozadí',
    syncNowAriaLabel: 'Synchronizovať teraz z {url}',
    ...
    hubInclusion: {
      heading: 'Žiadosti o zaradenie do hubu',
      description: 'Požiadajte o zaradenie vašej komunitnej skupiny do domény hubu. Správca hubu žiadosť skontroluje pred jej verejným zobrazením.',
      empty: 'Zatiaľ žiadne žiadosti o zaradenie do hubu.',
      requestTitle: 'Požiadať o zaradenie do hubu',
      selectHub: 'Vyberte hub',
      selectHubPlaceholder: 'Vyberte doménu hubu…',
      noteLabel: 'Poznámka pre recenzentov (voliteľná)',
      notePlaceholder: 'Vysvetlite, prečo je vaša komunita relevantná pre tento hub…',
      submitRequest: 'Odoslať žiadosť',
      requestSent: '✓ Žiadosť o zaradenie odoslaná. Správca hubu ju čoskoro skontroluje.',
      allRequested: 'Vaša komunita už požiadala o zaradenie alebo je zaradená vo všetkých dostupných huboch.',
      statusPending: 'Čaká na schválenie',
      statusApproved: 'Schválené',
      statusRejected: 'Zamietnuté',
      rejectedNote: 'Poznámka k zamietnutiu',
      errorLoad: 'Nepodarilo sa načítať asociácie hubov.',
      errorRequest: 'Nepodarilo sa odoslať žiadosť o zaradenie. Skúste to znova.',
    },
  },
  ...
  discussion: {
    ...
    postReply: 'Odoslať odpoveď',
    posting: 'Odosielam…',
    cancel: 'Zrušiť',
    reply: 'Odpovedať',
    hide: 'Skryť',
    hiding: 'Skrývam…',
    hidden: 'Táto správa bola odstránená organizátorom.',
    badgeOrganizer: 'Organizátor',
    badgeAdmin: 'Správca platformy',
    validationEmpty: 'Prosím zadajte otázku.',
    validationTooLong: 'Správa nesmie presiahnuť 2 000 znakov.',
    loadError: 'Diskusiu sa nepodarilo načítať.',
    postError: 'Správu sa nepodarilo odoslať. Skúste to prosím znova.',
    hideError: 'Položku sa nepodarilo skryť. Skúste to prosím znova.',
    justNow: 'práve teraz',
  },
}
