export default {
  ...
  admin: {
    ...
    rejectionPanelHeading: 'Zur Überarbeitung zurücksenden',
    eventRejectionNotePlaceholder: 'Erklären Sie, was der Organisator vor der erneuten Einreichung korrigieren muss (optional)',
    submitRejection: 'Zur Überarbeitung zurücksenden',
    cancelRejection: 'Abbrechen',
    queueTag: 'Tag',
    queueDate: 'Datum',
    queueStatus: 'Status',
    queueActions: 'Aktionen',
    submittedToday: 'Heute eingereicht',
    submittedDaysAgo: 'Vor {days} T eingereicht',
    warn_shortDescription: 'Kurze Beschreibung',
    warn_missingVenue: 'Kein Veranstaltungsort',
    warn_missingCity: 'Keine Stadt',
    warn_missingTimezone: 'Keine Zeitzone',
    warn_missingDomain: 'Kein Tag',
    rejCat_incompleteInfo: 'Unvollständige Infos',
    rejCat_weakDescription: 'Schwache Beschreibung',
    rejCat_invalidUrl: 'Ungültige URL',
    rejCat_wrongCategory: 'Falsche Kategorie',
    rejCat_pastEvent: 'Vergangene Veranstaltung',
    rejCat_duplicate: 'Duplikat',
  ...
  hubManage: {
    ...
    curatedCommunities: {
      title: 'Kuratierte Community-Gruppen',
      hint: 'Wählen Sie öffentliche Community-Gruppen für diesen Hub aus. Jeder Eintrag kann aktiviert/deaktiviert und mit einer kurzen Erklärung versehen werden.',
      empty: 'Noch keine kuratierten Community-Gruppen.',
      loadError: 'Kuratierte Communities konnten nicht geladen werden.',
      saveError: 'Kuratierte Communities konnten nicht gespeichert werden. Bitte erneut versuchen.',
      reviewError: 'Die Anfrage konnte nicht verarbeitet werden. Bitte erneut versuchen.',
      saved: '✓ Gespeichert',
      saving: 'Speichern…',
      ...
      remove: 'Entfernen',
      annotation: 'Steward-Hinweis (optional)',
      annotationPlaceholder: 'z.B. Kernorganisatorgruppe dieses Hubs…',
      enabled: 'Aktiviert (öffentlich anzeigen)',
      disabledBadge: 'Deaktiviert',
      noEligibleGroups: 'Keine öffentlichen Community-Gruppen zum Hinzufügen verfügbar.',
      groupPublic: 'Öffentlich',
      groupPrivate: 'Privat',
      pendingRequestsTitle: 'Ausstehende Aufnahmeanträge',
      requestNote: 'Hinweis des Antragstellers',
      approve: 'Genehmigen',
      reject: 'Ablehnen',
      rejectionNotePlaceholder: 'Optionaler Ablehnungsgrund…',
    },
  },
  ...
  community: {
    ...
    hubInclusion: {
      heading: 'Hub-Aufnahmeanträge',
      description: 'Beantragen Sie, dass Ihre Community-Gruppe in einem Domain-Hub vorgestellt wird. Ein Hub-Administrator prüft den Antrag, bevor er öffentlich erscheint.',
      empty: 'Noch keine Hub-Aufnahmeanträge.',
      requestTitle: 'Aufnahme in einen Hub beantragen',
      selectHub: 'Hub auswählen',
      selectHubPlaceholder: 'Domain-Hub auswählen…',
      noteLabel: 'Hinweis für Prüfer (optional)',
      notePlaceholder: 'Erklären Sie, warum Ihre Community für diesen Hub relevant ist…',
      submitRequest: 'Antrag senden',
      requestSent: '✓ Aufnahmeantrag gesendet. Ein Hub-Administrator wird ihn in Kürze prüfen.',
      allRequested: 'Ihre Community hat bereits Aufnahmeanträge gestellt oder ist in allen verfügbaren Hubs vertreten.',
      statusPending: 'Ausstehend',
      statusApproved: 'Genehmigt',
      statusRejected: 'Abgelehnt',
      rejectedNote: 'Ablehnungsgrund',
      errorLoad: 'Hub-Zuordnungen konnten nicht geladen werden.',
      errorRequest: 'Der Aufnahmeantrag konnte nicht gesendet werden. Bitte erneut versuchen.',
    },
  },
  ...
  discussion: {
    ...
    hidden: 'Diese Nachricht wurde vom Organisator entfernt.',
    badgeOrganizer: 'Organisator',
    badgeAdmin: 'Plattform-Admin',
    validationEmpty: 'Bitte geben Sie eine Frage ein.',
    validationTooLong: 'Die Nachricht darf 2.000 Zeichen nicht überschreiten.',
    loadError: 'Diskussion konnte nicht geladen werden.',
    postError: 'Ihre Nachricht konnte nicht gesendet werden. Bitte versuchen Sie es erneut.',
    hideError: 'Eintrag konnte nicht ausgeblendet werden. Bitte versuchen Sie es erneut.',
    justNow: 'gerade eben',
  },
}
