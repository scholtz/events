export default {
  ...
  eventDetail: {
    ...
    unableToLoadDescription:
      'We could not load this event right now. Please check your connection and try again.',
    ...
    noExactLocation: 'No exact location available. Use the address above to find the venue.',
    ...
    saveThisEvent: 'Save this event',
    unsaveEvent: 'Unsave event',
    signInToSave: 'Sign in to save events',
    offlineStale:
      "You're offline – this data may not be current. Refresh when you're back online.",
  },
  ...
  dashboard: {
    ...
    pleaseLogIn: 'Please log in to see your dashboard.',
    submitEvent: '+ Submit Event',
