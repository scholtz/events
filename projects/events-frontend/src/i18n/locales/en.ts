export default {
  ...
  dashboard: {
    ...
    recentSavesThisWeek: '+{count} saves this week',
    recentSavesThisMonth: '+{count} saves this month',
    recentCalendarThisWeek: '+{count} calendar adds this week',
    recentCalendarThisMonth: '+{count} calendar adds this month',
  ...
  portfolio: {
    ...
    ariaFilterDomain: 'Filter by category',
    ariaFilterLanguage: 'Filter by language',
    ariaFilterDateFrom: 'Filter from date',
    ariaFilterDateTo: 'Filter to date',
    ariaSortEvents: 'Sort events',
    // Sort
    sortBy: 'Sort by',
  ...
  admin: {
    ...
    domainSlugPlaceholder: 'e.g. crypto',
    domainSubdomainPlaceholder: 'e.g. crypto',
    domainDescriptionPlaceholder: 'Description (optional)',
    noDomainsYet: 'No domains yet. Add one above.',
    domainOverviewSaved: '\u2713 Saved',
    ...
    rejectionPanelHeading: 'Return for changes',
    eventRejectionNotePlaceholder: 'Explain what the organizer needs to fix before resubmitting (optional)',
    submitRejection: 'Return for changes',
    ...
    submittedDaysAgo: 'Submitted {days}d ago',
    warn_shortDescription: 'Short description',
    warn_missingVenue: 'No venue',
    warn_missingCity: 'No city',
    warn_missingTimezone: 'No timezone',
    warn_missingDomain: 'No tag',
    rejCat_incompleteInfo: 'Incomplete info',
    rejCat_weakDescription: 'Weak description',
    rejCat_invalidUrl: 'Invalid URL',
    rejCat_wrongCategory: 'Wrong category',
    rejCat_pastEvent: 'Past event',
    rejCat_duplicate: 'Duplicate',
    ...
    communityGroupMembers: 'Members',
    communityGroupPending: 'Pending',
    communityGroupStatus: 'Status',
    communityGroupActions: 'Actions',
    communityGroupActive: 'Active',
    communityGroupInactive: 'Inactive',
    communityGroupView: 'View',
    communityGroupViewAriaLabel: 'View community {name}',
    noCommunityGroups: 'No community groups have been created yet.',
  },
  ...
  hubManage: {
    ...
    schedules: {
      title: 'Scheduled Featured Events',
      hint: 'Promote specific events during a defined time window. Active schedules appear ahead of standard results on the hub page.',
      empty: 'No scheduled highlights yet.',
      loadError: 'Unable to load schedules.',
      saveError: 'Failed to save schedule. Please try again.',
      addNew: '+ Add scheduled highlight',
      event: 'Event',
    ...
    curatedCommunities: {
      title: 'Curated Community Groups',
      hint: 'Select public community groups to feature on this hub. Each entry can be enabled/disabled and annotated with a short note explaining why the group is relevant.',
      empty: 'No community groups curated yet.',
      loadError: 'Unable to load curated communities.',
      saveError: 'Failed to save curated communities. Please try again.',
      reviewError: 'Unable to process this request. Please try again.',
      saved: '✓ Saved',
      saving: 'Saving…',
      ...
      add: 'Add community',
      remove: 'Remove',
      annotation: 'Steward note (optional)',
      annotationPlaceholder: 'e.g. Core organizer group for this hub…',
      enabled: 'Enabled (show publicly)',
      disabledBadge: 'Disabled',
      noEligibleGroups: 'No public community groups are available to add.',
      groupPublic: 'Public',
      groupPrivate: 'Private',
      pendingRequestsTitle: 'Pending inclusion requests',
      requestNote: 'Note from requester',
      approve: 'Approve',
      reject: 'Reject',
      rejectionNotePlaceholder: 'Optional rejection note…',
    },
  },
  ...
  community: {
    ...
    lastSyncedSuccessfully: 'Last successful sync',
    lastSyncNoSuccess: 'Last sync had errors',
    ...
    autoSyncEnabled: 'Background sync runs automatically every hour',
    autoSyncDisabled: 'Background sync is disabled for this source',
    enableAutoSync: 'Enable auto-sync',
    disableAutoSync: 'Disable auto-sync',
    enableAutoSyncAriaLabel: 'Enable automatic background sync',
    disableAutoSyncAriaLabel: 'Disable automatic background sync',
    syncNowAriaLabel: 'Sync now from {url}',
    ...
    hubInclusion: {
      heading: 'Hub Inclusion Requests',
      description: 'Request that your community group be featured in a domain hub. A hub administrator will review the request before it appears publicly.',
      empty: 'No hub inclusion requests yet.',
      requestTitle: 'Request inclusion in a hub',
      selectHub: 'Select a hub',
      selectHubPlaceholder: 'Choose a domain hub…',
      noteLabel: 'Note for reviewers (optional)',
      notePlaceholder: 'Explain why your community is relevant to this hub…',
      submitRequest: 'Send request',
      requestSent: '✓ Inclusion request sent. A hub administrator will review it shortly.',
      allRequested: 'Your community has already requested or is featured in all available hubs.',
      statusPending: 'Pending review',
      statusApproved: 'Approved',
      statusRejected: 'Rejected',
      rejectedNote: 'Rejection note',
      errorLoad: 'Unable to load hub associations.',
      errorRequest: 'Unable to send the inclusion request. Please try again.',
    },
  },
  ...
  discussion: {
    ...
    hide: 'Hide',
    hiding: 'Hiding…',
    hidden: 'This message was removed by the organizer.',
    badgeOrganizer: 'Organizer',
    badgeAdmin: 'Platform Admin',
    validationEmpty: 'Please enter a question.',
    validationTooLong: 'The message must not exceed 2 000 characters.',
    loadError: 'Unable to load discussion.',
    postError: 'Unable to post your message. Please try again.',
    hideError: 'Unable to hide this entry. Please try again.',
    justNow: 'just now',
  },
}
