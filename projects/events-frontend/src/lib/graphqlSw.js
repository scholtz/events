 ...
 */
export function makeGraphQlCacheKey(url, query, variables) {
 ...
 */
export function openGqlDb(idb = indexedDB) {
 ...
 */
export function idbPut(db, entry, maxEntries = GQL_MAX_ENTRIES) {
    return new Promise((resolve, reject) => {
