...
public sealed class AppDbContext(DbContextOptions<AppDbContext> options) : DbContext(options)
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<EventDomain>(entity =>
        {
            ...
            entity.Property(domain => domain.Tagline).HasMaxLength(150);
            ...
            entity.Property(domain => domain.SubmitEventCta).HasMaxLength(300);
        ...
        {
            entity.Property(dl => dl.Title).HasMaxLength(200);
            entity.Property(dl => dl.Url).HasMaxLength(1000);

            entity.HasIndex(dl => new { dl.DomainId, dl.DisplayOrder });
